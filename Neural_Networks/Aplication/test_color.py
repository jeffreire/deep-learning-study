...
# obtendo a camada oculta com a funcao de ativacao sigmoid
    layer_hidden = reluFunction(sum_sinapse1)
...
# calacularando a derivada da camada oculta atraves da sinapse 1
    derivada_layer_hidden = reluFunction(sum_sinapse1)
...
# save(w_hidden,w_output, bias_hidden, bias_output)